...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`GNANAM R `}</title>

        <meta
          name="description"
          content="Experience the thrill of entertainment and convenience of car sharing with GNANAM R - Your ultimate solution for fun and mobility."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1603190287605-e6ade32fa852?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlbnRlcnRhaW5tZW50fGVufDB8fHx8MTY4OTk5NDQxOXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@tijsvl?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Tijs van Leur`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the thrill of entertainment and convenience of car sharing with GNANAM R - Your ultimate solution for fun and mobility.`}
            </Text>
            <Box
