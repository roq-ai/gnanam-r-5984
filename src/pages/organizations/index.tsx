...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'car_sharing.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('car_sharing', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'car_sharing',
          header: 'Car Sharing',
          accessorKey: 'car_sharing',
          cell: ({ row: { original: record } }: any) => record?._count?.car_sharing,
        }
      : null,
